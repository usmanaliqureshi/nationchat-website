    ...
    <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        <div className="col-span-full lg:col-span-1">
          ...
          <p className='inline-flex gap-x-2 text-sm text-gray-400 hover:text-gray-200 focus:outline-none focus:text-gray-200 mt-3'>We are NationCHAT. We are known as the place “where fun begins”.</p>
        </div>
        {/* End Col */}
      ...
      <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
        <div className="flex justify-between items-center">
          <p className="text-sm text-gray-400">
            NationCHAT IRC Network © 2024. All Rights Reserved.
          </p>
        </div>
        {/* End Col */}
        {/* Social Brands */}
